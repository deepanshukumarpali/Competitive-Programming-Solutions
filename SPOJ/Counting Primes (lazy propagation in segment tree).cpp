...
void Update(ll left,ll right ,ll val,ll l=0,ll r=n-1,ll cur=0)
{
...
//    print(l,r);nl;
   if(lazy[cur]!=-1)
   {
    ...
    ll m=l+(r-l)/2;
    Update(left,right,val,l,m,2*cur+1);
    Update(left,right,val,m+1,r,2*cur+2);
