...
void ApplyLazyness(ll cur,ll l,ll r)
{
    if(lazy[cur]!=0)
    {
        st[cur]=(r-l+1)-st[cur];
...
void Update(ll left,ll right,ll l=0,ll r=n-1,ll cur=0)
{
    ...
    ll m=l+(r-l)/2;
    Update(left,right,l,m,2*cur+1);
    Update(left,right,m+1,r,2*cur+2);
